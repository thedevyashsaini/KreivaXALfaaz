...
export default function LandingPage() {
  ...
  return (
    <div className="flex flex-col setheight relative overflow-x-hidden custom-scrollbar landingBack overflow-y-hidden">
      <TopNav />
      <Image height={300} width={300} src="/topcloud.png" alt="cloud"
      ...
      <div ref={clouds.ref}  className="w-screen h-3/5 overflow-hidden md:overflow-visible relative z-1">
        <Image height={300} width={300} src="/image 8.png" alt="cloud"
               className="w-3/5 md:w-5/12 absolute top-40 md:top-20 left-0 -translate-x-24 md:-translate-x-10" />
        <Image height={300} width={300} src="/image 10.png" alt="cloud"
               className="w-3/5 md:w-5/12 absolute top-80 md:top-60 right-0 md:right-40 translate-x-24 md:translate-x-20" />
      </div>

      <Image width={400} height={400} ref={hero.ref}  src="/hero.gif" alt="kreivaXalfaaz" className="flex flex-col w-11/12 md:w-6/12
      ...
      <div className="flex flex-col w-full md:w-9/12
        ...
        <Image height={400} width={400} src="/hero.gif" alt="kreivaXalfaaz" />
      </div>
      <Image width={100} height={100} ref={man.ref} src="ManTowerSun.svg" alt="manTowerSun" className="man absolute w-screen hidden md:block md:top-1200 top-1/3 z-1" />
      <Image width={100} height={100} ref={man_cropped.ref}  src="ManTowerSun_Cropped.svg" alt="manTowerSun" className="absolute w-screen md:hidden top-32 md:top-0 z-1" />
      ...
      hidden md:flex md:flex-wrap item-center justify-center md:w-960 mx-auto z-20 absolute left-0 right-0 top-130" style={{maxWidth: "900px"}}>
        ...
        <div className="artists"><Image width={200} height={200} src="/artist1.png" alt="artst" /></div>
        <div className="artists"><Image width={200} height={200} src="/artist2.jpeg" alt="artst" /></div>
        <div className="artists"><Image width={200} height={200} src="/artist3.jpeg" alt="artst" /></div><br/>
        <div className="artists"><Image width={200} height={200} src="/artist4.JPG" alt="artst" /></div>
        <div className="artists"><Image width={200} height={200} src="/artist5.jpg" alt="artst" /></div>
      </div>
